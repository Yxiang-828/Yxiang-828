...
<table>
  <tr>
    <td width="50%" valign="top">
      ...
      <p><sub>TypeScript · Node.js · React Native · SQLite · Ollama/OpenRouter · Tailscale</sub></p>
    </td>
    <td width="50%" valign="top">
      ...
      <p><sub>React · MapLibre · MQTT · Redis · FastAPI · Qwen3-TTS</sub></p>
    </td>
  </tr>
  <tr>
    <td width="50%" valign="top">
      ...
      <p><sub>React · Vite · TypeScript · Vercel Edge · OpenAI/OpenRouter · Mermaid C4</sub></p>
    </td>
    <td width="50%" valign="top">
      ...
      <p><sub>Python · FastAPI · Next.js · SEA-LION · MERaLiON · MediaPipe WASM</sub></p>
    </td>
  </tr>
  <tr>
    <td width="50%" valign="top">
      ...
      <p><sub>Python · FastAPI · SQLite · Telegram Bot API · SSE</sub></p>
    </td>
    <td width="50%" valign="top">
      ...
      <p><sub>React · Electron · Python · FastAPI · SQLite · Ollama</sub></p>
    </td>
  </tr>
</table>
